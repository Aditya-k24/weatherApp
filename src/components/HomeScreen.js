  ...
  return (
    <>
      <div className="container bkgImg">
        ...
        <div className="bottom row justify-content-evenly text-center rounded">
          <div className="feels box col-md-3">
            {data.main ? (
              <p>
                {" "}
          ...
          <div className="temp-min box col-md-3">
            {data.main ? (
              <p>
          ...
          <div className="temp-max box col-md-3">
            {data.main ? (
              <p>
        ...
        <br />
        <div className=" bottom3 row justify-content-evenly text-center  ">
          <div className="humidity box col-md-3">
            {data.main ? (
              <p>
          ...
          <div className="wind box col-md-3">
            {data.wind ? (
              <p>
